            ...
            <div className="modalLogin border">
              <form className="modalLogin_container">
                ...
                <div className="modalLogin--head">
                  ...
                  <h2 className="h5">Avant de commencer à naviguer sur la plateforme, on a besoin d’un peu plus d’informations.</h2>
                  <h3 className="h5">Ce formulaire ne devrait pas prendre plus de 3 minutes à compléter alors c’est parti pour un onboarding rapide :</h3>
                </div>
                ...
                <button onClick={handleRegister} className="btn btn-purple-solid-intense">Inscription</button>

                <p className="text_center">Votre adresse e-mail ne sera utilisée pour rien d’autre, promis !</p>

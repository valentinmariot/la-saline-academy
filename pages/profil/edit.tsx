    ...
    <Template title="Paramètre profil">
      <div className={styles.page_editProfil}>
        ...
        <div className={styles.tab_left}>
            <button
                id="tab1"
                className={`button_profil ${activeTab === 'tab1' ? 'button_profil__active' : ''}`}
            ...
            <button
                id="tab2"
                className={`button_profil ${activeTab === 'tab2' ? 'button_profil__active' : ''}`}
            ...
            <button
                id="tab3"
                className={`button_profil button_profil__destructive ${activeTab === 'tab3' ? 'button_profil__active' : ''}`}

        ...
        <div className={styles.page_profil}>
            ...
            <div>
                <div className={styles.head_cours + ' dflex'}>
                    ...
                    <a href="" className="btn btn-gray-link hover-effect">Voir tout</a>
                </div>
                <div className="grid4">
            ...
            <hr/>
            <div>
                <h4><BasicIcon name="edit" size="m"/> Quick notes</h4>
                <div className={styles.listing_notes + ' grid2'}>
                    {visibleCardsNote.map((cardNote, index) => (
                        <CardNote key={index} title={cardNote.title} desc={cardNote.desc} href={cardNote.href} />
                    ))}
                </div>
                <button className="btn btn-purple-link hover-effect ml-auto" onClick={handleToggleCardsNote}>
                    {showAllCardsNote ? 'Afficher moins' : 'Afficher plus'}
                    <BasicIcon name={showAllCardsNote ? 'circle-arrow-up' : 'circle-arrow-down'} size="s" />
                </button>
            </div>
        </div>
    );

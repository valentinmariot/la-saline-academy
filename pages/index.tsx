                    ...
                    <div className="dflexcolumn gap24">
                        <div className="grid2 gap24">
                            <div className="card_pack-lp">
                                <div>
                                    <h3 className="h4 card_pack--title">
                                        Apprenez plus vite avec <span className="purple">Quick Notes</span>
                                    </h3>
                                    <p>La fonctionnalité qui vous permet de retenir l’essentiel pour vous. Disponible sur toutes les leçons et cours.</p>
                                </div>
                            ...
                            <div className="card_pack-lp">
                                <div>
                                    <h3 className="h4 card_pack--title">
                                        Participer aux <span className="purple">Challenges</span>
                                    </h3>
                                    <p>Soyez le premier à réalisez les challenges hebdomadaire pour gagner des points et des accès à des cours exclusif.</p>
                                </div>
                                <div className="ml-auto purple-icon">
                        ...
                        <div id="bento" className="grid3 gap24">
                            <div className="card_pack-lp">
                                <div>
                                    <h3 className="h4 card_pack--title">
                                        ...
                                        sur le <span className="purple">Forum</span>
                                    </h3>
                                    <p>Soyez le premier à réalisez les challenges hebdomadaire pour gagner des points et des accès à des cours exclusif.</p>
                                </div>
                                <div className="ml-auto purple-icon">
                            ...
                            <div className="card_pack-lp">
                                <div>
                                    <h3 className="h4 card_pack--title">
                                        Formations délivrer par des <span className="purple">Professionnels</span>
                                    </h3>
                                    <p>Soyez le premier à réalisez les challenges hebdomadaire pour gagner des points et des accès à des cours exclusif.</p>
                                </div>
                                <div className="ml-auto purple-icon">
                            ...
                            <div className="card_pack-lp">
                                <div>
                                    <h3 className="h4 card_pack--title">
                                        Suiver votre avancer <span className="purple">Pas à Pas</span>
                                    </h3>
                                    <p>Soyez le premier à réalisez les challenges hebdomadaire pour gagner des points et des accès à des cours exclusif.</p>
                                </div>
                                <div className="ml-auto purple-icon">
              ...
              <div id="offres" className={stylesLp.block}>
                  <div className="lp_container">
                      <div className={stylesLp.blockHead}>
                          ...
                          <p className="text_center">Choisissez parmi nos 2 offres disponibles</p>
                      </div>
                      <div className="grid3">
                          <div className="card_pack-lp">
                              <div>
                          ...
                          <div className="card_pack-lp disabled">
                              ...
                              <div>
                                  <Link
                                      href="/authentification/register" id="choisir" className="btn btn-purple-solid">
                                      Arrive bientôt
                                  </Link>
                              </div>
                          </div>
              ...
              <div id="contact" className={stylesLp.block}>
                  ...
                  <div className="grid2 max-width-1100 gap32 p-l-24 p-r-24">
                      ...
                      <div className='dflexcolumn'>
                          ...
                          <ul>
                              <li><b>Créer le plus complet et le plus prestigieux
                                  catalogue </b><b>international de master class filmées de musique classique et
                                  baroque.</b></li>
                              <br/>
                              <li>Offrir une chance aux jeunes musiciens du monde entier
                                  de <b>réaliser leur rêve et d’ouvrir leur carrière à l’international en suivant les
                                      enseignements des plus grands Maîtres de musique</b> lors des&nbsp;<em>Saline
                                      royale Academy</em>&nbsp;à la Saline royale d’Arc-et-Senans (France), et <b>en
                                      accédant 24H/24, sans contrainte ni limite, à l’excellence de l’enseignement musical
                                      on-line</b>.
                              </li>
                              <br/>
                              <li><b>Sauvegarder, en haute définition, le patrimoine
                                  exceptionnel que représentent la richesse et la diversité des enseignements et des
                                  techniques des plus grands Maîtres</b>, face à l’uniformisation des jeux et des
                                  styles.
                              </li>
                          </ul>
                          <p>L’offre de services digitale est constituée d’un accès par
                              abonnement à des contenus exclusifs destinés aux étudiants, professeurs et institutions
                              musicales.
                          </p>
                      </div>
                  </div>
